        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 mb-10">
          ...
          <div className="basis-1/2 md:text-left text-center">
            ...
            <p className="text-justify  desktop:text-xl md:mx-0 mx-auto">
              ...
              responsive, and secure. We also make use of advanced analytics and
              tracking tools to continually improve the user experience and
              increase engagement.
              <br />
              <br />
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 mb-10">
          ...
          <div className="basis-1/2 md:text-left text-center">
            ...
            <p className="text-justify  desktop:text-xl md:mx-0 mx-auto">
              ...
              development and deployment, we work tirelessly to ensure that our
              apps are innovative, intuitive, and engaging.
            </p>
          </div>
        </div>
      </div>
