        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 mb-10">
          <div className="basis-1/2 md:text-left text-center order-2 md:order-1">
            ...
            <p className="text-justify  desktop:text-xl md:mx-0 mx-auto">
              ...
              that your software meets the highest standards of quality and
              performance.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 mb-10">
          ...
          <div className="basis-1/2 md:text-left text-center">
            ...
            <p className="text-justify  desktop:text-xl md:mx-0 mx-auto">
              ...
              functional, providing a seamless experience for both you and your
              users. Utilizing the latest technologies and frameworks, our
              software is built with speed, functionality, and security in mind.
              <br />
              <br />
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 mb-10">
          <div className="basis-1/2 md:text-left text-center order-2 md:order-2">
            ...
            <p className="text-justify  desktop:text-xl md:mx-0 mx-auto">
              ...
              the extra mile to ensure that our customers receive the quality of
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 mb-10">
          ...
          <div className="basis-1/2 md:text-left text-center">
            ...
            <p className="text-justify  desktop:text-xl md:mx-0 mx-auto">
              ...
              This enables us to respond quickly to changes in requirements and
              prioritize features that offer the greatest benefit to our
              customers.
              <br />
              <br />
